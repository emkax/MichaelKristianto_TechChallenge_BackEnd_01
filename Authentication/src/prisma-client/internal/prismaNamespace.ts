...
export const CoffeeOrderByRelevanceFieldEnum = {
  name: 'name',
  description: 'description'
} as const

export type CoffeeOrderByRelevanceFieldEnum = (typeof CoffeeOrderByRelevanceFieldEnum)[keyof typeof CoffeeOrderByRelevanceFieldEnum]
...
/**
 * Reference to a field of type 'CoffeeSize'
 */
export type EnumCoffeeSizeFieldRefInput<$PrismaModel> = FieldRefInputType<$PrismaModel, 'CoffeeSize'>
